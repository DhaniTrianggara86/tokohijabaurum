<template>
              ...
              <div class="col-lg-12">
                <div class="proceed-checkout text-left">
                  <ul>
                    ...
                    <li class="subtotal mt-3">
                      Ongkos kirim + Berat
                      <span>kg Rp{{ ditambahongkir }},00</span>
                    </li>
                    <li class="subtotal mt-3">
                      Total Biaya
                    ...
                    <li class="subtotal mt-3">
                      Nama Penerima
                      <span>Krishna Yudha</span>
                    </li>
                  </ul>
                  <!-- <router-link to="/success"> -->
                    <a @click="checkout()" class="proceed-btn">Pesan Sekarang</a>
                  <!-- </router-link> -->
                </div>
              </div>
            </div>
 ...
 import HeaderAurum from "@/components/HeaderAurum";
 ...
 export default {
  ...
  methods: {
    ...
    checkout(){
      ...
      axios
        .post(
          "http://backend_toko_hijab_aurum.test/api/checkout",
          checkoutData
        )
  ...
  computed:{
      totalHarga(){
          ...
          ditambahongkir(){
              return (this.totalHarga * 12) / 100;
          },
          totalBiaya() {
              return this.totalHarga + this.ditambahongkir;
          }
      }
  };
