            ...
            <div class="container">
                <div class="ht-left">
                    <div class="mail-service">
                        <i class=" fa fa-envelope"></i> aurumhijab@gmail.com
                    </div>
                    <div class="phone-service">
                        <i class=" fa fa-phone"></i> +6281395515375
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="inner-header">
                <div class="row">
                    <div class="col-lg-2 col-md-2">
                        <div class="logo">
                            <a href="./index.html">
                                <img src="img/logo_Aurum1.png" alt="" />
                            </a>
                        </div>
                    </div>
                                ...
                                <div class="cart-hover">
                                    ...
                                    <div class="select-button"> 
                                        ...
                                        <a href="#" class="primary-btn view-card">
                                            <router-link to="/KeranjangBelanja" style="color: #FFF;">VIEW CARD</router-link>
                                            </a>
                                      
                                        
                                        <router-link to="/KeranjangBelanja" class="primary-btn checkout-btn">CHECK OUT</router-link>
                                    </div>
                                </div>  
                            </li>
                        </ul>
